        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="flex items-center space-x-2 h-9 px-4 py-2 border border-[#e5e5e5] hover:bg-slate-100 justify-center gap-2 rounded-md text-sm font-medium transition-colors disabled:opacity-50 cursor-pointer"
            >
              <FiLogOut size={16} />
              <span> Logout </span>
            </button>
